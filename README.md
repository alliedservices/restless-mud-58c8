...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-mud-58c8
```

A live public deployment of this template is available at [https://restless-mud-58c8.templates.workers.dev](https://restless-mud-58c8.templates.workers.dev)
